...
fun GameScreen(
    ...
    Column(
        ...
        GameStatus(gameUiState.wordCount,score = gameUiState.score)
        GameLayout(
...
fun GameLayout(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            label = { Text(stringResource(if(isGuessedWrong) R.string.wrong_guess else R.string.enter_your_word)) },
